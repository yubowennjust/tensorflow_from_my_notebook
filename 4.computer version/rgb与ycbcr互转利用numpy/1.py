...
img = io.imread('D:/GitHub/tensorflow_from_my_notebook/4.computer version/images/m_1342505545217.jpg')
...
io.imshow(rgb2ycbcr(img))
plot.show()

io.imshow(ycbcr2rgb(rgb2ycbcr(img)))
plot.show()
